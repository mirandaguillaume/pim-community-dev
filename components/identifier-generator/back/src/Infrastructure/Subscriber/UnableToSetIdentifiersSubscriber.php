 ...
 */
#[AsEventListener(event: UnableToSetIdentifierEvent::class, method: 'storeEvent')]
#[AsEventListener(event: EventInterface::ITEM_STEP_AFTER_BATCH, method: 'writeWarnings')]
final class UnableToSetIdentifiersSubscriber implements UnableToSetIdentifiersSubscriberInterface
{
