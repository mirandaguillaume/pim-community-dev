...
final class GetFamiliesControllerEndToEnd extends ControllerEndToEndTestCase
{
    ...
    public function it_returns_a_list_of_families_with_pagination(): void
    {
        ...
        Assert::assertEquals($expectedFirstPage, \json_decode($firstResponse->getContent(), true, 512, JSON_THROW_ON_ERROR));
        ...
        Assert::assertEquals($expectedSecondPage, \json_decode($response->getContent(), true, 512, JSON_THROW_ON_ERROR));
    }
    ...
    public function it_returns_a_list_of_families_with_search_params(): void
    {
        ...
        Assert::assertSame($expected, \json_decode($response->getContent(), true, 512, JSON_THROW_ON_ERROR));
    }
}
