 ...
 */
class SimpleSelectPropertyTest extends TestCase
{
    private SimpleSelectProperty $sut;
    ...
    {
        $this->assertInstanceOf(SimpleSelectProperty::class, $this->sut);
    }

    public function test_it_returns_a_type(): void
    {
        $this->assertSame('simple_select', $this->sut->type());
    }
    ...
    {
        $property = SimpleSelectProperty::fromNormalized([
            'type' => 'simple_select',
            'attributeCode' => 'color',
            'process' => ['type' => 'truncate', 'operator' => '=', 'value' => 3],
        ]);
    ...
    {
        $this->assertSame('color', $this->sut->attributeCode());
    }
