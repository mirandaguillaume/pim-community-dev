...
use Akeneo\Pim\Automation\IdentifierGenerator\Application\Match\Condition\MatchSimpleSelectHandler;
...
class MatchSimpleSelectHandlerTest extends TestCase
{
    private MatchSimpleSelectHandler $sut;

    protected function setUp(): void
    {
        $this->sut = new MatchSimpleSelectHandler();
    }

    public function test_it_should_support_only_simple_select_conditions(): void
    {
        $this->assertSame(SimpleSelect::class, $this->sut->getConditionClass());
    }

    public function test_it_should_throw_exception_when_invoked_with_something_else_than_simple_select_condition(): void
    {
