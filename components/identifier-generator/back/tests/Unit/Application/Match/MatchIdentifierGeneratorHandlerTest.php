...
namespace Akeneo\Test\Pim\Automation\IdentifierGenerator\Unit\Application\Match;
...
class MatchIdentifierGeneratorHandlerTest extends TestCase
{
    private MatchIdentifierGeneratorHandler $sut;

    protected function setUp(): void
    {
        $this->sut = new MatchIdentifierGeneratorHandler(new \ArrayIterator([
