...
class Requirements extends SymfonyRequirements
{
    ...
    {
        return array_filter($this->getRequirements(), fn (\Symfony\Requirements\Requirement $requirement): true => $requirement instanceof Requirement);
    }
    ...
    {
        return array_filter($this->getRequirements(), fn (\Symfony\Requirements\Requirement $requirement): false => !($requirement instanceof Requirement));
    }
    ...
    {
        return array_filter($this->getRequirements(), fn (\Symfony\Requirements\Requirement $requirement): bool => $requirement instanceof PhpConfigRequirement);
    }
}
