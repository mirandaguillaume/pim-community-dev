...
{
    public function __construct(private readonly EventNormalizer $eventNormalizer)
    {
    }
    ...
    public function normalize($object, $format = null, array $context = []): array
    {
        ...
        return array_map(fn (Event $event): array => $this->eventNormalizer->normalize($event), $object->getEvents());
    }
    ...
    public function denormalize($data, $type, $format = null, array $context = []): BulkEvent
    {
        ...
        $events = array_map(fn (array $eventData): \Akeneo\Platform\Component\EventQueue\Event => $this->eventNormalizer->denormalize($eventData, $eventData['type']), $data);
