...
final class JobExecutionEvents
{
     ...
     * @staticvar string
     */
    public const string PRE_SHOW = 'pim_import_export.job_execution.pre_show';
     ...
     * @staticvar string
     */
    public const string PRE_DOWNLOAD_LOG = 'pim_import_export.job_execution.pre_dl_log';
     ...
     * @staticvar string
     */
    public const string PRE_DOWNLOAD_FILES = 'pim_import_export.job_execution.pre_dl_files';
}
