...
final readonly class AddViewedAnnouncementsByUserHandler
{
    ...
    {
        $viewedAnnouncements = array_map(fn (string $viewedAnnouncementId): \Akeneo\Platform\CommunicationChannel\Domain\Announcement\Model\Write\ViewedAnnouncement => ViewedAnnouncement::create(
