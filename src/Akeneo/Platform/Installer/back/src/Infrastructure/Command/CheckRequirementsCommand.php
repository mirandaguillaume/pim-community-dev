 ...
 */
#[AsCommand(name: 'pim:installer:check-requirements', description: 'heck requirements for Akeneo PIM')]
...
class CheckRequirementsCommand extends Command
{
    ...
    /**
     * @param array<int, \Symfony\Requirements\Requirement|\Symfony\Requirements\PhpConfigRequirement> $collection
     */
