...
class DashboardRatesTest extends TestCase
{
    private DashboardRates $sut;

    protected function setUp(): void
    {
    }

    public function test_it_get_rates_by_channel_locale_and_time_period(): void
    {
        ...
        $this->sut = new DashboardRates($rates, new ChannelCode('ecommerce'), new LocaleCode('en_US'), new TimePeriod('daily'));
