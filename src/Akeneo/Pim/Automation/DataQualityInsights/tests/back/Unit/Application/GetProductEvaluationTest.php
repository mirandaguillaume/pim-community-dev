 ...
 */
class GetProductEvaluationTest extends TestCase
{
    ...
    private CompleteEvaluationWithImprovableAttributes|MockObject $completeEvaluationWithImprovableAttributes;
    private GetProductEvaluation $sut;
    ...
    protected function setUp(): void
    {
        ...
        $this->completeEvaluationWithImprovableAttributes = $this->createMock(CompleteEvaluationWithImprovableAttributes::class);
        $this->sut = new GetProductEvaluation(
            $this->getCriteriaEvaluationsByProductIdQuery,
            $this->getLocalesByChannelQuery,
            $this->criteriaRegistry,
            $this->completeEvaluationWithImprovableAttributes
        );
    }

    public function test_it_gives_the_evaluation_of_a_product(): void
    {
        ...
        $this->criteriaRegistry->method('getEnabledCriterionCodes')->willReturn([
        ...
        $this->completeEvaluationWithImprovableAttributes->method('__invoke')->with($criteriaEvaluations)->willReturn($completedCriteriaEvaluations);
        $this->assertEquals($this->getExpectedProductEvaluation(), $this->sut->get($productUuid));
    }

    public function test_it_gives_the_evaluation_of_a_product_model(): void
    {
        ...
        $this->getCriteriaEvaluationsByProductIdQuery->method('execute')->with($productModelId)->willReturn($criteriaEvaluations);
        $completedCriteriaEvaluations = $this->givenCompletedCriteriaEvaluations($criteriaEvaluations);
        $this->completeEvaluationWithImprovableAttributes->method('__invoke')->with($criteriaEvaluations)->willReturn($completedCriteriaEvaluations);
        $this->assertEquals($this->getExpectedProductEvaluation(), $this->sut->get($productModelId));
    }

    public function test_it_handle_deprecated_improvable_attribute_structure(): void
    {
        $this->getLocalesByChannelQuery->method('getChannelLocaleCollection')->willReturn(new ChannelLocaleCollection([
                    'ecommerce' => ['en_US'],
                ]));
        ...
        $this->getCriteriaEvaluationsByProductIdQuery->method('execute')->with($productUuid)->willReturn($criteriaEvaluations);
        $this->completeEvaluationWithImprovableAttributes->method('__invoke')->with($criteriaEvaluations)->willReturn($criteriaEvaluations);
        $expectedEvaluation = [
                    "ecommerce" => [
                        "en_US" => [
                            [
