 ...
 */
class TransformCommonCriterionResultDataIdsTest extends TestCase
{
    private TransformCommonCriterionResultDataIds $sut;
    ...
    public function test_it_removes_unknown_attributes_from_result_data(): void
    {
        $dataToTransform = [
                    TransformCriterionEvaluationResultCodes::DATA_TYPES_ID['attributes_with_rates'] => [
                        1 => [
