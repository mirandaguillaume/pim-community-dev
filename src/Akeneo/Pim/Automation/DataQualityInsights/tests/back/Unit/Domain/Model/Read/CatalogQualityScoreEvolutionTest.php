...
class CatalogQualityScoreEvolutionTest extends TestCase
{
    private CatalogQualityScoreEvolution $sut;

    protected function setUp(): void
    {
    }

    public function test_it_returns_catalog_score_evolution(): void
    {
        ...
        $this->sut = new CatalogQualityScoreEvolution($today, $scores, 'print', 'en_US');
        $this->assertEquals([
                    'average_rank' => 'C',
                    'data' => [
                        $fiveMonthsAgo => 'C',
