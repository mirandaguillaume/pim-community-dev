...
class MarkProductModelsEvaluationImpactedByUpdatedProductModelsTaskletTest extends TestCase
{
    private CreateCriteriaEvaluations|MockObject $createCriteriaEvaluations;
    private GetUpdatedEntityIdsQueryInterface|MockObject $getUpdatedProductModelIdsQuery;
    private LoggerInterface|MockObject $logger;
    private MarkProductModelsEvaluationImpactedByUpdatedProductModelsTasklet $sut;

    protected function setUp(): void
    {
        $this->createCriteriaEvaluations = $this->createMock(CreateCriteriaEvaluations::class);
        $this->getUpdatedProductModelIdsQuery = $this->createMock(GetUpdatedEntityIdsQueryInterface::class);
        $this->logger = $this->createMock(LoggerInterface::class);
        $this->sut = new MarkProductModelsEvaluationImpactedByUpdatedProductModelsTasklet($this->createCriteriaEvaluations, $this->getUpdatedProductModelIdsQuery, $this->logger, 2);
    }

    public function test_it_is_a_tasklet(): void
    {
        $this->assertInstanceOf(TaskletInterface::class, $this->sut);
        $this->assertInstanceOf(MarkProductModelsEvaluationImpactedByUpdatedProductModelsTasklet::class, $this->sut);
    }

    public function test_it_marks_product_models_evaluation_impacted_by_updated_product_models(): void
    {
    ...
    public function test_it_does_not_interrupt_the_job_if_an_error_occurs(): void
    {
        ...
        $this->getUpdatedProductModelIdsQuery->method('since')->willThrowException(new \Exception('error'));
