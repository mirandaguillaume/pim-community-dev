...
use Akeneo\Pim\Automation\DataQualityInsights\Infrastructure\Elasticsearch\GetDataQualityInsightsPropertiesForProductProjection;
use PHPUnit\Framework\MockObject\MockObject;
use PHPUnit\Framework\TestCase;
use Ramsey\Uuid\Uuid;

class GetDataQualityInsightsPropertiesForProductProjectionTest extends TestCase
{
    ...
    private GetDataQualityInsightsPropertiesForProductProjection $sut;
    ...
    protected function setUp(): void
    {
        ...
        $this->sut = new GetDataQualityInsightsPropertiesForProductProjection($this->getProductScoresQuery, $this->computeProductsKeyIndicators, $this->idFactory);
    }

    public function test_it_returns_additional_properties_from_product_identifiers(): void
    {
        ...
        $this->idFactory->method('createCollection')->with(['df470d52-7723-4890-85a0-e79be625e2ed', 'fef37e64-a963-47a9-b087-2cc67968f0a2', '6d125b99-d971-41d9-a264-b020cd486aee'])->willReturn($productUuidCollection);
        $channelEcommerce = new ChannelCode('ecommerce');
        $channelMobile = new ChannelCode('mobile');
        $localeEn = new LocaleCode('en_US');
        $localeFr = new LocaleCode('fr_FR');
        $this->getProductScoresQuery->method('byProductUuidCollection')->with($productUuidCollection)->willReturn([
        ...
        $this->computeProductsKeyIndicators->method('compute')->with($productUuidCollection)->willReturn($productsKeyIndicators);
        $this->assertSame([
                    $uuid42->toString() => [
                ...
                ], $this->sut->fromProductUuids($uuids));
    }
}
