 ...
 */
#[AsCommand(name: 'pim:data-quality-insights:evaluations', description: 'Launch the evaluations of products and structure')]
...
class LaunchEvaluationsCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            $this->runUniqueProcessJob->run('data_quality_insights_evaluations', fn (?JobExecution $lastJobExecution): array => []);
