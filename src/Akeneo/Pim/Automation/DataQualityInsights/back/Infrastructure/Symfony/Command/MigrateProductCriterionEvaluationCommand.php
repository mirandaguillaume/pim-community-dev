 ...
 */
#[AsCommand(name: 'pimee:data-quality-insights:migrate-product-criterion-evaluation', description: 'Migrate the products criteria evaluations with empty results and pending status.', hidden: true)]
