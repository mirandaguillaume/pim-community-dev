...
final readonly class GetDataQualityInsightsPropertiesForProductModelProjection implements GetAdditionalPropertiesForProductModelProjectionInterface
{
    ...
    public function fromProductModelCodes(array $productModelCodes, array $context = []): array
    {
        ...
        $productModelIdCollection = $this->idFactory->createCollection(array_map(fn (\Akeneo\Pim\Automation\DataQualityInsights\Domain\ValueObject\ProductEntityIdInterface $id): string => (string) $id, array_values($productModelCodesIds)));
