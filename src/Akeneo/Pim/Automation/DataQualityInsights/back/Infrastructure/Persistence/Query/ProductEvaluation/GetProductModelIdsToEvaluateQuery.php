 ...
 */
final readonly class GetProductModelIdsToEvaluateQuery implements GetEntityIdsToEvaluateQueryInterface
{
    ...
    public function execute(?int $limit = null, int $bulkSize = GetEntityIdsToEvaluateQueryInterface::BULK_SIZE): \Generator
    {
        ...
        $stmt = $this->db->executeQuery($sql, ['status' => CriterionEvaluationStatus::PENDING], ['status' => ParameterType::STRING]);
