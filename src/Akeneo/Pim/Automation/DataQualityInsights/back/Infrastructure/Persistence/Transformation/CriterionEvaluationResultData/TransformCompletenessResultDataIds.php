 ...
 */
final readonly class TransformCompletenessResultDataIds implements TransformResultDataIdsInterface
{
    ...
    public function transformToCodes(array $resultData): array
    {
        ...
        if (null !== $numberOfImprovableAttributes) {
            ...
            $dataByCodes['number_of_improvable_attributes'] = $this->transformChannelLocaleDataIds->transformToCodes($improvableAttributes, fn (array $attributesList): int => count($attributesList));
        }
