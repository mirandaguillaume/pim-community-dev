...
class CriteriaApplicabilityRegistry
{
    ...
    {
        return array_map(fn (string $code): \Akeneo\Pim\Automation\DataQualityInsights\Domain\ValueObject\CriterionCode => new CriterionCode($code), array_keys($this->criterionApplicabilityServices));
    }
}
