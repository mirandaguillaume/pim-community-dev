...
final class SynchronousCriterionEvaluationsFilter implements SynchronousCriterionEvaluationsFilterInterface
{
    ...
    {
        return array_filter(iterator_to_array($iterator), fn (CriterionEvaluation $criterionEvaluation): bool => in_array(strval($criterionEvaluation->getCriterionCode()), self::SYNCHRONOUS_CRITERION_CODES));
    }
}
