...
final class CriterionEvaluationResultStatusCollection implements \IteratorAggregate
{
    ...
    {
        return $this->resultsStatus->mapWith(fn (CriterionEvaluationResultStatus $resultStatus): string => strval($resultStatus));
    }
    ...
    public static function fromArrayString(array $rawStatusCollection): self
    {
        ...
        $statusCollection->resultsStatus = ChannelLocaleDataCollection::fromNormalizedChannelLocaleData($rawStatusCollection, fn ($status): \Akeneo\Pim\Automation\DataQualityInsights\Domain\ValueObject\CriterionEvaluationResultStatus => new CriterionEvaluationResultStatus($status));
