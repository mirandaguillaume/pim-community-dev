...
final class RanksDistributionCollection implements \IteratorAggregate
{
    ...
    {
        $this->channelLocaleRanksDistributions = $this->mapRanksDistributions(fn (array $ranksDistribution): \Akeneo\Pim\Automation\DataQualityInsights\Domain\Model\RanksDistribution => new RanksDistribution($ranksDistribution), $channelLocaleRanksDistributions);
    }
    ...
    {
        return $this->mapRanksDistributions(fn (RanksDistribution $ranksDistribution): array => $ranksDistribution->toArray(), $this->channelLocaleRanksDistributions);
    }

    public function getAverageRanks(): array
    {
        return $this->mapRanksDistributions(fn (RanksDistribution $ranksDistribution): ?\Akeneo\Pim\Automation\DataQualityInsights\Domain\ValueObject\Rank => $ranksDistribution->getAverageRank(), $this->channelLocaleRanksDistributions);
    }
