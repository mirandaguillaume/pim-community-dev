...
{
    final public const array ALLOWED_LINK_TYPES = [
        'products',
        'product_uuids',
        'product_models',
    ];

    final public const int MAX_ASSOCIATIONS = 100;
    final public const int MIN_QUANTITY = 1;
    final public const int MAX_QUANTITY = 2_147_483_647;
