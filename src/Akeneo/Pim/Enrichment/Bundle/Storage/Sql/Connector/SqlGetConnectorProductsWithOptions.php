...
class SqlGetConnectorProductsWithOptions implements Query\GetConnectorProducts
{
    ...
    private function getConnectorProductsWithLabels(array $connectorProducts): array
    {
        ...
        return array_map(fn (ConnectorProduct $product): \Akeneo\Pim\Enrichment\Component\Product\Connector\ReadModel\ConnectorProduct => $product->buildLinkedData($optionWithLabels), $connectorProducts);
    }
