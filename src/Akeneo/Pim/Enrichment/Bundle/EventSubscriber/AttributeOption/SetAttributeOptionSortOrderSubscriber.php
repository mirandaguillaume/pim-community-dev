 ...
 */
#[AsEventListener(event: StorageEvents::PRE_SAVE, method: 'onPreSave')]
#[AsEventListener(event: StorageEvents::PRE_SAVE_ALL, method: 'onPreSaveAll')]
class SetAttributeOptionSortOrderSubscriber
{
