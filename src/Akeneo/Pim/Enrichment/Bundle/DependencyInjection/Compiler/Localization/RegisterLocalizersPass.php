...
{
    final public const string LOCALIZATION_LOCALIZER_REGISTRY = 'pim_catalog.localization.localizer.registry';

    final public const string LOCALIZATION_LOCALIZER_TAG = 'pim_catalog.localization.localizer';
