...
final readonly class UpsertProductCommand
{
    ...
    private static function create(
        ...
        $associationUserIntents = \array_values(
            \array_filter($userIntents, fn (\Akeneo\Pim\Enrichment\Product\API\Command\UserIntent\UserIntent $userIntent): bool => $userIntent instanceof AssociationUserIntent)
        );
        $quantifiedAssociationUserIntents = \array_values(
            \array_filter($userIntents, fn (\Akeneo\Pim\Enrichment\Product\API\Command\UserIntent\UserIntent $userIntent): bool => $userIntent instanceof QuantifiedAssociationUserIntent)
        );
