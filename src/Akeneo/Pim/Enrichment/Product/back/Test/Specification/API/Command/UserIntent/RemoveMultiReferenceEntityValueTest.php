 ...
 */
class RemoveMultiReferenceEntityValueTest extends TestCase
{
    private RemoveMultiReferenceEntityValue $sut;

    protected function setUp(): void
    {
        $this->sut = new RemoveMultiReferenceEntityValue('attribute_ref_entity', null, null, ['Akeneo', 'Ziggy']);
    }

    public function test_it_is_initializable(): void
    {
        $this->assertInstanceOf(RemoveMultiReferenceEntityValue::class, $this->sut);
    ...
    public function test_it_can_only_be_instantiated_with_string_record_codes(): void
    {
        ...
        new RemoveMultiReferenceEntityValue('attribute_ref_entity', null, null, ['test', 12, false]);
    }

    public function test_it_cannot_be_instantiated_with_empty_record_codes(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        new RemoveMultiReferenceEntityValue('attribute_ref_entity', null, null, []);
    }

    public function test_it_cannot_be_instantiated_if_one_of_the_record_codes_is_empty(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        new RemoveMultiReferenceEntityValue('attribute_ref_entity', null, null, ['a', '', 'b']);
    }
}
