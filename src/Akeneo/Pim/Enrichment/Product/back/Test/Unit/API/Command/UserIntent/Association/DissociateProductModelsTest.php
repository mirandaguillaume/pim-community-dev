 ...
 */
class DissociateProductModelsTest extends TestCase
{
    private DissociateProductModels $sut;

    protected function setUp(): void
    {
        $this->sut = new DissociateProductModels('X_SELL', ['code1', 'code2']);
    }

    public function test_it_is_initializable(): void
    {
        $this->assertInstanceOf(DissociateProductModels::class, $this->sut);
