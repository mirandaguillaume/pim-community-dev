 ...
 */
class ReplaceAssociatedProductsTest extends TestCase
{
    private ReplaceAssociatedProducts $sut;

    protected function setUp(): void
    {
        $this->sut = new ReplaceAssociatedProducts('X_SELL', ['identifier1', 'identifier2']);
    }

    public function test_it_is_initializable(): void
    {
        $this->assertInstanceOf(ReplaceAssociatedProducts::class, $this->sut);
    ...
    public function test_it_can_only_be_instantiated_with_string_product_identifiers(): void
    {
        ...
        new ReplaceAssociatedProducts('X_SELL', ['test', 12, false]);
    }

    public function test_it_can_be_instantiated_with_empty_product_identifiers(): void
    {
        $this->sut = new ReplaceAssociatedProducts('X_SELL', []);
        $this->assertSame([], $this->sut->productIdentifiers());
    }

    public function test_it_cannot_be_instantiated_if_one_of_the_product_identifiers_is_empty(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        new ReplaceAssociatedProducts('X_SELL', ['a', '', 'b']);
    }

    public function test_it_cannot_be_instantiated_with_empty_association_type(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        new ReplaceAssociatedProducts('', ['identifier1', 'identifier2']);
    }
}
