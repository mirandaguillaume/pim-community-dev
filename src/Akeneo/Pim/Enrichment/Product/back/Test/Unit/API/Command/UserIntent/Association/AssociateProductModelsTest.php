 ...
 */
class AssociateProductModelsTest extends TestCase
{
    private AssociateProductModels $sut;

    protected function setUp(): void
    {
        $this->sut = new AssociateProductModels('X_SELL', ['code1', 'code2']);
    }

    public function test_it_is_initializable(): void
    {
        $this->assertInstanceOf(AssociateProductModels::class, $this->sut);
