 ...
 */
class DissociateGroupsTest extends TestCase
{
    private DissociateGroups $sut;

    protected function setUp(): void
    {
        $this->sut = new DissociateGroups('X_SELL', ['group1', 'group2']);
    }

    public function test_it_is_initializable(): void
    {
        $this->assertInstanceOf(DissociateGroups::class, $this->sut);
