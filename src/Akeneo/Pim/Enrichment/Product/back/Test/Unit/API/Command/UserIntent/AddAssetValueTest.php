 ...
 */
class AddAssetValueTest extends TestCase
{
    private AddAssetValue $sut;

    protected function setUp(): void
    {
        $this->sut = new AddAssetValue('name', 'ecommerce', 'en_US', ['packshot1', 'packshot2']);
    }

    public function test_it_is_initializable(): void
    {
        $this->assertInstanceOf(AddAssetValue::class, $this->sut);
