...
class SetMultipleValuesApplierTest extends TestCase
{
    private ObjectUpdaterInterface|MockObject $updater;
    private SetMultipleValuesApplier $sut;

    protected function setUp(): void
    {
        $this->updater = $this->createMock(ObjectUpdaterInterface::class);
        $this->sut = new SetMultipleValuesApplier($this->updater);
    }

    public function test_it_is_initializable(): void
    {
        $this->assertInstanceOf(SetMultipleValuesApplier::class, $this->sut);
        $this->assertInstanceOf(UserIntentApplier::class, $this->sut);
    }

    public function test_it_applies_set_multiple_values_user_intent(): void
    {
        $product = new Product();
        ...
        $this->sut->apply($setMultiSelectValue, $product, 1);
    }
