 ...
 */
class ClearPriceValueTest extends TestCase
{
    private ClearPriceValue $sut;

    protected function setUp(): void
    {
        $this->sut = new ClearPriceValue('name', 'ecommerce', 'en_US', 'EUR');
    }

    public function test_it_is_initializable(): void
    {
        $this->assertInstanceOf(ClearPriceValue::class, $this->sut);
    ...
    public function test_it_returns_the_currency_code(): void
    {
        $this->assertSame('EUR', $this->sut->currencyCode());
    }
}
