 ...
 */
#[ORM\Entity()]
#[ORM\Table(name: 'pim_catalog_association_type_translation')]
...
class AssociationTypeTranslation extends AbstractTranslation implements AssociationTypeTranslationInterface
{
    ...
    #[ORM\ManyToOne(targetEntity: \Akeneo\Pim\Structure\Component\Model\AssociationTypeInterface::class, inversedBy: 'translations')]
