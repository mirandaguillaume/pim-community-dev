...
{
    /** @staticvar string */
    final public const string ATTRIBUTE_TYPE_TAG = 'pim_catalog.attribute_type';

    /** @staticvar string */
    final public const string ATTRIBUTE_TYPE_REGISTRY = 'pim_catalog.registry.attribute_type';
