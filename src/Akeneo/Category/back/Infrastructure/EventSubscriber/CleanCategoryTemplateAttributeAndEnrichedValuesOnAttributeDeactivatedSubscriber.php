 ...
 */
#[AsEventListener(event: AttributeDeactivatedEvent::class, method: 'cleanCategoryDataForAttribute')]
class CleanCategoryTemplateAttributeAndEnrichedValuesOnAttributeDeactivatedSubscriber
{
