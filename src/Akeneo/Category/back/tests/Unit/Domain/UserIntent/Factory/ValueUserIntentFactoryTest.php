 ...
 */
class ValueUserIntentFactoryTest extends TestCase
{
    private GetCategoryTemplateAttributeSql|MockObject $getAttribute;
    private ValueUserIntentFactory $sut;

    protected function setUp(): void
    {
        $this->getAttribute = $this->createMock(GetCategoryTemplateAttributeSql::class);
    ...
    public function testItCreatesAListOfValueIntentBasedOnValuesField(): void
    {
        ...
        $this->getAttribute->expects($this->once())->method('byUuids')->with($uuids)->willReturn($attributes);
        $expectedUseIntents = [
            new SetTextArea(
    ...
    public function testItDoesNotAddValueUserIntentWhenCorrespondingAttributeTypeNoFound(): void
    {
        ...
        $this->getAttribute->expects($this->once())->method('byUuids')->with($uuids)->willReturn($valueCollection);
