 ...
 */
class DeactivatedTemplateAttributesInValueCollectionFilterTest extends TestCase
{
    /**
    ...
    public function testItRemovesDeactivatedAttributesFromValueCollection(): void
    {
        ...
        $deactivatedAttributesCleaner = new DeactivatedTemplateAttributesInValueCollectionFilter();
    ...
    public function testItRemovesNothingFromValueCollectionWhenNoDeactivatedAttributes(): void
    {
        ...
        $this->assertEquals($rawValueCollection, $actual);
    }
}
