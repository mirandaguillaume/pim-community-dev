    ...
    public function normalize(): array
    {
        return [
            $this->getKeyWithChannelAndLocale() => [
                'channel' => $this->channel instanceof \Akeneo\Category\Domain\ValueObject\Attribute\Value\ChannelValue ? (string) $this->channel : null,
                'locale' => $this->locale instanceof \Akeneo\Category\Domain\ValueObject\Attribute\Value\LocaleValue ? (string) $this->locale : null,
