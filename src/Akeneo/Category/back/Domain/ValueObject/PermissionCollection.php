...
final class PermissionCollection
{
    ...
    {
        return [
            self::VIEW => array_map(fn (array $permission): int => $permission['id'], $this->getViewUserGroups()),
            self::EDIT => array_map(fn (array $permission): int => $permission['id'], $this->getEditUserGroups()),
            self::OWN => array_map(fn (array $permission): int => $permission['id'], $this->getOwnUserGroups()),
        ];
    }
