...
describe('AuditEventType', () => {
    describe('string values', () => {
        it("PRODUCT_CREATED is 'product_created'", () =>
            expect(AuditEventType.PRODUCT_CREATED).toBe('product_created'));
        it("PRODUCT_UPDATED is 'product_updated'", () =>
            expect(AuditEventType.PRODUCT_UPDATED).toBe('product_updated'));
