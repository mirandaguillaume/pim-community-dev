...
export const CreateCustomAppForm: FC<Props> = ({onCancel, setCredentials}) => {
  ...
  return (
    <>
      ...
      <FormHelper>
        <p>
          {translate('akeneo_connectivity.connection.connect.custom_apps.create_modal.app_information.description')}
          <span className="cline-any cline-neutral">&nbsp;</span>
          <Link href={'https://api.akeneo.com/apps/create-custom-app.html'}>
            {translate('akeneo_connectivity.connection.connect.custom_apps.create_modal.app_information.link')}
          </Link>
        </p>
      </FormHelper>
