 ...
 */
#[AsCommand(name: 'akeneo:connectivity-connection:openid-keys:create', description: 'Create or update a public/private key couple to be used to sign openid token and store it into database')]
