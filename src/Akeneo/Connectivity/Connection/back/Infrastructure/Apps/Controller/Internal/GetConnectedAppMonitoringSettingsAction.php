 ...
 */
final readonly class GetConnectedAppMonitoringSettingsAction
{
    ...
    public function __invoke(Request $request, string $connectionCode): Response
    {
        ...
        if (!$connection instanceof \Akeneo\Connectivity\Connection\Domain\Settings\Model\Read\ConnectionWithCredentials) {
