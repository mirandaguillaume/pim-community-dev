...
class CreateConnectionEndToEnd extends WebTestCase
{
    public function test_it_creates_a_connection(): void
    {
        ...
        $expectedResult = ['code' => 'franklin', 'label' => 'Franklin', 'flow_type' => FlowType::DATA_SOURCE, 'image' => null, 'user_group_id' => null, 'auditable' => false, 'type' => 'default', ...$expectedResultForAutoGeneratedValues];
