...
class ConnectionLabelTest extends TestCase
{
    ...
    public function test_it_cannot_contains_a_string_shorter_than_3_characters(): void
    {
        ...
        $this->expectExceptionMessage('akeneo_connectivity.connection.connection.constraint.label.too_short');
    ...
    public function test_it_cannot_contains_a_string_longer_than_100_characters(): void
    {
        ...
        $this->expectExceptionMessage('akeneo_connectivity.connection.connection.constraint.label.too_long');
    ...
    public function test_it_cannot_contains_an_empty_string(): void
    {
        ...
        $this->expectExceptionMessage('akeneo_connectivity.connection.connection.constraint.label.required');
        new ConnectionLabel('');
    }
}
