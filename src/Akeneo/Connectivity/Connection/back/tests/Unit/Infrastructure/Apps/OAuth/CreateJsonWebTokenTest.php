 ...
 */
class CreateJsonWebTokenTest extends TestCase
{
    private GetAsymmetricKeysQueryInterface|MockObject $getAsymmetricKeysQuery;
    ...
    {
        $this->assertInstanceOf(CreateJsonWebToken::class, $this->sut);
    }
