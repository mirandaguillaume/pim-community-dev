...
use spec\Akeneo\Connectivity\Connection\Infrastructure\Apps\Controller\Internal\GetConnectedAppMonitoringSettingsAction;
use Symfony\Component\HttpFoundation\RedirectResponse;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\HttpKernel\Exception\AccessDeniedHttpException;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;

class GetConnectedAppMonitoringSettingsActionTest extends TestCase
{
    ...
    private GetConnectedAppMonitoringSettingsAction $sut;
    ...
    protected function setUp(): void
    {
        ...
        $this->sut = new GetConnectedAppMonitoringSettingsAction(
            $this->featureFlag,
            $this->security,
    ...
    public function test_it_throws_not_found_exception_with_not_existing_connection(): void
    {
        ...
        $this->expectException(new NotFoundHttpException('Connection with connection code foo does not exist.'));
        $this->sut->__invoke($request, 'foo');
    }
}
