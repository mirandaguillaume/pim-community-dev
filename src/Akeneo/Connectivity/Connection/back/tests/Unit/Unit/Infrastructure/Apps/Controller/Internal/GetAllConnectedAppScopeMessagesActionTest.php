...
class GetAllConnectedAppScopeMessagesActionTest extends TestCase
{
    ...
    private GetAllConnectedAppScopeMessagesAction $sut;
    ...
    protected function setUp(): void
    {
        ...
        $this->sut = new GetAllConnectedAppScopeMessagesAction(
            $this->featureFlag,
            $this->security,
