...
class ClientRegistrySpec extends ObjectBehavior
{
    ...
    public function it_registers_an_es_client(Client $client)
    {
    ...
    public function it_registers_multiple_es_clients(Client $client1, Client $client2)
    {
    ...
    public function it_returns_an_empty_list_when_no_clients_has_been_registered()
    {
