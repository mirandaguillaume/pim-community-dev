...
{
    public function it_creates_a_enable_refresh_param()
    {
        $this->beConstructedThrough('enable');
        $this->getType()->shouldReturn(Refresh::ENABLE);
    }

    public function it_creates_a_disable_refresh_param()
    {
        $this->beConstructedThrough('disable');
        $this->getType()->shouldReturn(Refresh::DISABLE);
    }

    public function it_creates_a_wait_for_refresh_param()
    {
