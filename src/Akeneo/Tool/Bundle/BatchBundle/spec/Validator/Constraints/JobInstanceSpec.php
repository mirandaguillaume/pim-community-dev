...
class JobInstanceSpec extends ObjectBehavior
{
    ...
    public function it_has_a_property()
    {
        $this->property->shouldBe('jobName');
    }

    public function it_returns_the_name_of_the_class_that_validates_this_constraint()
    {
        $this->validatedBy()->shouldReturn('akeneo_job_instance_validator');
    }

    public function it_returns_constraint_targets()
    {
