...
class PersistedConnectionEntityManagerSpec extends ObjectBehavior
{
    ...
    public function it_refreshes_connection_when_getting_connection($entityManager, Connection $connection, Result $result)
    {
    ...
    public function it_reconnects_when_connection_is_lost(
        $entityManager,
    ...
    public function it_refreshes_connection_when_flushing_data(
        $entityManager,
        Connection $connection,
        Result $result
    ) {
