...
class LabelCollection
{
    ...
    {
        $localeCodes = array_map(static fn (LocaleIdentifier $localeIdentifier): string => $localeIdentifier->normalize(), $localeIdentifiers);

        $filteredLabels = array_filter($this->translatedLabels, static fn (string $labelCode): bool => in_array($labelCode, $localeCodes), ARRAY_FILTER_USE_KEY);
