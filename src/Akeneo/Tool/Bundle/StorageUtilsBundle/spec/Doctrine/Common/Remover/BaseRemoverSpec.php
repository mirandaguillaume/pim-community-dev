...
{
    public function let(ObjectManager $objectManager, EventDispatcherInterface $eventDispatcher)
    {
    ...
    public function it_is_a_remover()
    {
        $this->shouldHaveType(RemoverInterface::class);
        $this->shouldHaveType(BulkRemoverInterface::class);
    }

    public function it_removes_the_object_and_flushes_the_unit_of_work($objectManager, ModelToRemove $type)
    {
    ...
    public function it_removes_the_objects_and_flushes_the_unit_of_work($objectManager, ModelToRemove $type1, ModelToRemove $type2)
    {
    ...
    public function it_throws_exception_when_remove_anything_else_than_the_expected_class()
    {
