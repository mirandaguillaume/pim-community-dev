...
class RegisterArchiversPassSpec extends ObjectBehavior
{
    ...
    public function it_does_not_process_anything_else_than_an_archivist_event_listener(ContainerBuilder $container)
    {
    ...
    public function it_processes_an_archivist_event_listener_container(ContainerBuilder $container, Definition $service)
    {
