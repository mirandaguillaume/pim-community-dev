...
{
    public function let(PathGeneratorInterface $pathGenerator)
    {
        $this->beConstructedWith($pathGenerator, FileInfo::class);
    }

    public function it_creates_a_file_from_a_raw_file($pathGenerator)
    {
    ...
    public function it_creates_a_file_from_an_uploaded_file($pathGenerator)
    {
