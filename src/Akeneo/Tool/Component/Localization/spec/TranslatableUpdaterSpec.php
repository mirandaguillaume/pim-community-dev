...
class TranslatableUpdaterSpec extends ObjectBehavior
{
    ...
    public function it_removes_the_translation_when_the_new_label_is_null(
    ...
    public function it_removes_the_translation_when_the_new_label_is_empty(
        TranslatableInterface $object,
        LabelTranslationInterface $translation
    ) {
        $object->setLocale('en_US')->shouldBeCalled();
    ...
    public function it_set_a_new_label_when_the_new_label_is_not_empty(
        TranslatableInterface $object,
        LabelTranslationInterface $translation
    ) {
        $object->setLocale('en_US')->shouldBeCalled();
