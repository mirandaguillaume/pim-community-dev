...
class VersionSpec extends ObjectBehavior
{
    ...
    public function it_has_a_resource_id()
    {
        $this->getResourceId()->shouldBe(1537);
    }

    public function it_has_no_resource_uuid()
    {
        $this->getResourceUuid()->shouldBeNull();
    }

    public function it_can_be_constructed_with_a_uuid()
    {
    ...
    public function it_has_a_resource_name()
    {
    ...
    public function it_has_a_snapshot()
    {
    ...
    public function it_stores_date_of_getting_logged()
    {
        $this->getLoggedAt()->shouldHaveType('\DateTime');
    }

    public function it_can_have_a_pending_state()
    {
