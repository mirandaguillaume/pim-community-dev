...
{
    public function it_cannot_be_instantiated_with_an_empty_key()
    {
        $this->beConstructedThrough('fromFileStorage', ['', 'catalogStorage', 'files/media.png']);
        $this->shouldThrow(\InvalidArgumentException::class)->duringInstantiation();
    }

    public function it_cannot_be_instantiated_with_an_empty_storage()
    {
        $this->beConstructedThrough('fromFileStorage', ['a/b/c/media.png', '', 'files/media.png']);
        $this->shouldThrow(\InvalidArgumentException::class)->duringInstantiation();
    }

    public function it_cannot_be_instantiated_with_an_empty_filepath()
    {
        $this->beConstructedThrough('fromFileStorage', ['a/b/c/media.png', 'catalogStorage', '']);
        $this->shouldThrow(\InvalidArgumentException::class)->duringInstantiation();
    }

    public function it_can_describe_a_remote_storage_file()
    {
    ...
    public function it_can_describe_a_local_file()
    {
