...
{
    public function it_is_built_for_local()
    {
    ...
    public function it_is_built_for_remote()
    {
    ...
    public function it_is_built_from_local_location_url()
    {
    ...
    public function it_is_built_from_remote_location_url()
    {
