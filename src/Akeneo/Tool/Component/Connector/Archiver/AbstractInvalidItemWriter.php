...
abstract class AbstractInvalidItemWriter extends AbstractFilesystemArchiver
{
    ...
    {
        $emptyHeaderKeys = array_keys(array_filter($headers, fn (string $columnName): bool => '' === trim($columnName)));
    ...
    {
        return array_filter($headers, fn (string $columnName): bool => '' !== trim($columnName));
    }
