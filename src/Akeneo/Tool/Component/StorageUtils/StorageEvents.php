...
final class StorageEvents
{
     ...
     * @staticvar string
     */
    public const string PRE_REMOVE = 'akeneo.storage.pre_remove';
     ...
     * @staticvar string
     */
    public const string POST_REMOVE = 'akeneo.storage.post_remove';
     ...
     * @staticvar string
     */
    public const string PRE_REMOVE_ALL = 'akeneo.storage.pre_remove_all';
     ...
     * @staticvar string
     */
    public const string POST_REMOVE_ALL = 'akeneo.storage.post_remove_all';
     ...
     * @staticvar string
     */
    public const string PRE_SAVE = 'akeneo.storage.pre_save';
     ...
     * @staticvar string
     */
    public const string POST_SAVE = 'akeneo.storage.post_save';
     ...
     * @staticvar string
     */
    public const string PRE_SAVE_ALL = 'akeneo.storage.pre_save_all';
     ...
     * @staticvar string
     */
    public const string POST_SAVE_ALL = 'akeneo.storage.post_save_all';
}
