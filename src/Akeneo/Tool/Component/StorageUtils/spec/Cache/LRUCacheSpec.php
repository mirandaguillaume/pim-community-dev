...
final class LRUCacheSpec extends ObjectBehavior
{
    ...
    public function it_cannot_be_instantiated_with_zero_or_negative_value()
    {
    ...
    public function it_gets_result_for_single_key_by_calling_the_callable(EntityObjectQuery $entityObjectQuery)
    {
    ...
    public function it_gets_result_from_single_key_from_the_cache_and_does_not_call_the_callable_query(EntityObjectQuery $entityObjectQuery)
    {
    ...
    public function it_removes_the_least_recently_used_element_when_maximum_size_is_reached(EntityObjectQuery $entityObjectQuery)
    {
     ...
     */
    public function it_store_null_values_and_does_not_call_the_query_if_null_value_is_stored()
    {
    ...
    public function it_gets_multiple_keys_by_calling_the_callable(EntityObjectQuery $entityObjectQuery)
    {
        $entityObjectQuery
    ...
    public function it_does_not_store_all_entries_when_query_result_is_greater_than_cache_size(EntityObjectQuery $entityObjectQuery)
    {
        $entityObjectQuery
    ...
    public function it_call_the_callable_only_on_keys_that_are_not_in_the_cache(EntityObjectQuery $entityObjectQuery)
    {
        $entityObjectQuery->fromCode('entity_code_1')->willReturn(new EntityObject('entity_code_1'))->shouldBeCalledOnce();
    ...
    public function it_handles_string_keys_that_are_numeric(EntityObjectQuery $entityObjectQuery)
    {
