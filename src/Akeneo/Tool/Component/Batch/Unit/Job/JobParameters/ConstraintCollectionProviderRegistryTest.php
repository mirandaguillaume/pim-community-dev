...
{
    private ConstraintCollectionProviderRegistry $sut;

    protected function setUp(): void
    {
        $this->sut = new ConstraintCollectionProviderRegistry();
    }
    ...
    public function test_it_throws_an_exception_when_there_is_no_registered_provider(): void
    {
        ...
        $this->expectExceptionMessage('No constraint collection provider has been defined for the Job "myname"');
        $this->sut->get($job);
    }
}
