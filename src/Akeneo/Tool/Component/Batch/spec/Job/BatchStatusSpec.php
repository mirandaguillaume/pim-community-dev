...
class BatchStatusSpec extends ObjectBehavior
{
    ...
    public function it_returns_largest_of_two_values()
    {
    ...
    public function it_upgrades_finished_value_when_already_failed()
    {
    ...
    public function it_upgrades_finished_value_when_already_completed()
    {
    ...
    public function it_upgrades_unfinished_value_when_starting()
    {
    ...
    public function it_upgrades_unfinished_value_when_completed()
    {
        $this->beConstructedWith(BatchStatus::COMPLETED);
    ...
    public function it_is_not_running_when_failed()
    {
        $this->beConstructedWith(BatchStatus::FAILED);
        $this->isRunning()->shouldReturn(false);
    }

    public function it_is_not_running_when_completed()
    {
        $this->beConstructedWith(BatchStatus::COMPLETED);
        $this->isRunning()->shouldReturn(false);
    }

    public function it_is_running_when_started()
    {
        $this->beConstructedWith(BatchStatus::STARTED);
        $this->isRunning()->shouldReturn(true);
    }

    public function it_is_running_when_starting()
    {
        $this->beConstructedWith(BatchStatus::STARTING);
        $this->isRunning()->shouldReturn(true);
    }

    public function it_is_stopping_when_stopping()
    {
        $this->beConstructedWith(BatchStatus::STOPPING);
        $this->isStopping()->shouldReturn(true);
    }

    public function it_is_unsuccessful_when_failed()
    {
        $this->beConstructedWith(BatchStatus::FAILED);
        $this->isUnsuccessful()->shouldReturn(true);
    }

    public function it_is_successful_when_completed()
    {
        $this->beConstructedWith(BatchStatus::COMPLETED);
        $this->isUnsuccessful()->shouldReturn(false);
    }

    public function it_is_successful_when_started()
    {
        $this->beConstructedWith(BatchStatus::STARTED);
        $this->isUnsuccessful()->shouldReturn(false);
    }

    public function it_is_successful_when_starting()
    {
        $this->beConstructedWith(BatchStatus::STARTING);
        $this->isUnsuccessful()->shouldReturn(false);
    }

    public function it_is_pausing_when_pausing()
    {
        $this->beConstructedWith(BatchStatus::PAUSING);
        $this->isPausing()->shouldReturn(true);
    }

    public function it_is_paused_when_paused()
    {
