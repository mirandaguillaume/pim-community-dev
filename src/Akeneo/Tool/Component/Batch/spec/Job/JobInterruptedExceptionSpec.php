...
{
    public function it_provides_the_original_status_when_built_with_this_status(BatchStatus $status)
    {
    ...
    public function it_provides_a_stopped_status_when_built_without_any_status()
    {
        $this->beConstructedWith(
            'my_job_interupted_exception',
            0,
