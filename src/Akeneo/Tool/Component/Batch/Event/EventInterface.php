...
interface EventInterface
{
    ...
    public const BEFORE_STEP_EXECUTION_PAUSED = 'akeneo_batch.before_step_execution_paused';
    public const BEFORE_STEP_EXECUTION_RESUME = 'akeneo_batch.before_step_execution_resume';
