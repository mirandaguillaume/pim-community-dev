...
final class AccessLevel
{
    ...
    public const string NONE_LEVEL_NAME = 'NONE';
     ...
     * @param int $value
     */
    public static function getAccessLevelName($value): ?string
    {
