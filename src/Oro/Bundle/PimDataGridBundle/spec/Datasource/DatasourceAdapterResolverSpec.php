...
class DatasourceAdapterResolverSpec extends ObjectBehavior
{
    ...
    public function it_returns_an_orm_adapter_class_for_default_datasource_when_orm_support_is_enabled()
    {
        $this->getAdapterClass('pim_datasource_default')->shouldReturn('orm_adapter_class');
    }

    public function it_returns_a_product_orm_adapter_class_for_product_datasource_when_orm_support_is_enabled()
    {
        $this->getAdapterClass('pim_datasource_product')->shouldReturn('product_orm_adapter_class');
    }

    public function it_returns_an_orm_adapter_class_for_smart_datasource_when_orm_support_is_enabled()
    {
