...
use spec\Oro\Bundle\PimDataGridBundle\Datagrid\Configuration\Product\SelectedAttributesConfigurator;
use Symfony\Component\HttpFoundation\RequestStack;

class SelectedAttributesConfiguratorTest extends TestCase
{
    ...
    private SelectedAttributesConfigurator $sut;
    ...
    protected function setUp(): void
    {
        ...
        $this->sut = new SelectedAttributesConfigurator($this->attributeRepository, $this->userContext, $this->requestParams, $this->requestStack);
    }
