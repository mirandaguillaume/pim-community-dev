 ...
 */
define(['jquery', 'underscore', 'backgrid', 'oro/datagrid/select-row-cell'], function ($, _, Backgrid, SelectRowCell) {
  'use strict';
  ...
  return SelectRowCell.extend({
    ...
    render: function () {
      ...
      this.$el.find('[data-select-all-visible]').on(
        'click',
        _.bind(function (e) {
      ...
      this.$el.find('[data-select-none]').on(
        'click',
        _.bind(function (e) {
