...
var template = __pimInterop(require('pim/template/datagrid/filter/metric-filter'));
...
module.exports = NumberFilter.extend({
  ...
  _onDisable: function () {
    this.$('.choicefilter button.dropdown-toggle')
      .first()
      .html(_.__('Action') + '<span class="caret"></span>');
    this.$('.choicefilter button.dropdown-toggle')
      .last()
      .html(_.__('Unit') + '<span class="caret"></span>');
  },
