...
{
    final public const string PRODUCT_GRID_NAME = 'product-grid';
    final public const string ATTRIBUTE_GRID_NAME = 'attribute-grid';
    ...
    protected function adaptAttributeGrid(array $parameters): array
    {
        ...
        return [
            ...
            'options' => [
                ...
                'code' => empty($filters['code']) ? null : $filters['code'],
    ...
    private function adaptArrayFilter(array $value, ?array $fallback): ?array
    {
        ...
        return $filteredValue === [] ? $fallback : $filteredValue;
    }
