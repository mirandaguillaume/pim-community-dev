...
{
    /** @staticvar string */
    final public const string SELECTOR_EXTENSION_ID = 'pim_datagrid.extension.selector.orm_selector';

    /** @staticvar string */
    final public const string TAG_NAME = 'pim_datagrid.extension.selector';
