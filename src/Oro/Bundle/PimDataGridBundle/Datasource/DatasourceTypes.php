...
class DatasourceTypes
{
     ...
     * @staticvar string
     */
    final public const DATASOURCE_DEFAULT = 'pim_datasource_default';
     ...
     * @staticvar string
     */
    final public const DATASOURCE_SMART = 'pim_datasource_smart';
     ...
     * @staticvar string
     */
    final public const DATASOURCE_PRODUCT = 'pim_datasource_product';
     ...
     * @staticvar string
     */
    final public const DATASOURCE_ORO = 'orm';
}
