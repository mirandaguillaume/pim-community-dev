...
var TextInputContainer = styled.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n"], ["\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n"])));
...
var CharacterLeftLabel = styled.div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  font-size: ", ";\n  align-self: flex-end;\n  color: ", ";\n"], ["\n  font-size: ", ";\n  align-self: flex-end;\n  color: ", ";\n"])), getFontSize('small'), getColor('grey', 100));
var TextInput = forwardRef(function (_a, forwardedRef) {
    ...
    return (React.createElement(TextInputContainer, null,
        React.createElement(Input, __assign({ ref: forwardedRef, onChange: handleChange, type: "text", readOnly: readOnly, disabled: readOnly, "aria-invalid": invalid, invalid: invalid, title: rest.value }, rest)),
