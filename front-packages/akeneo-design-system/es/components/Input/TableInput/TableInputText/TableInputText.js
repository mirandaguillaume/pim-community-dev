...
var EditableTableInputText = styled(TextInput)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  height: 39px;\n  padding-left: 10px;\n  padding-right: 10px;\n  border-radius: 0;\n  border: none;\n  background: none;\n\n  ", ";\n\n  &:focus {\n    box-shadow: 0 0 0 1px ", ";\n  }\n"], ["\n  height: 39px;\n  padding-left: 10px;\n  padding-right: 10px;\n  border-radius: 0;\n  border: none;\n  background: none;\n\n  ", ";\n\n  &:focus {\n    box-shadow: 0 0 0 1px ", ";\n  }\n"])), highlightCell, getColor('grey', 100));
var TableInputText = function (_a) {
    ...
    if (readOnly) {
        ...
        return (React.createElement(EditableTableInputText, __assign({ value: value }, rest), children));
};
