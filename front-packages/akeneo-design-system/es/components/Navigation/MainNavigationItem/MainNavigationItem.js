...
var TagContainer = styled.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  overflow: hidden;\n  position: absolute;\n  right: 0;\n  top: 7px;\n  width: 50%;\n"], ["\n  overflow: hidden;\n  position: absolute;\n  right: 0;\n  top: 7px;\n  width: 50%;\n"])));
var MainNavigationItem = React.forwardRef(function (_a, forwardedRef) {
    ...
    var tag = null;
    var taglessChildren = React.Children.map(children, function (child) {
    ...
    return (React.createElement(Link, __assign({ ref: forwardedRef, href: disabled ? undefined : href, active: active, disabled: disabled, "aria-disabled": disabled, onClick: handleClick }, rest),
        React.cloneElement(icon, { size: 24 }),
        tag && React.createElement(TagContainer, null, tag),
        React.createElement(Label, null, taglessChildren)));
});
