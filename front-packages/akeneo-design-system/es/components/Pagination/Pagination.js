...
var Pagination = function (_a) {
    ...
    return (React.createElement(PaginationContainer, { sticky: sticky }, pages.map(function (page, index) {
        return (React.createElement(PaginationItem, { currentPage: page === currentPage, key: index, followPage: followPage, page: page }));
    })));
};
