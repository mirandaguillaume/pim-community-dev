...
var TooltipIcon = styled(HelpPlainIcon)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  margin: ", "px;\n  color: ", ";\n"], ["\n  margin: ", "px;\n  color: ", ";\n"])), TooltipIconMargin, getColor('blue', 100));
var TooltipContent = styled.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  ", "\n  position: fixed;\n  z-index: 1901;\n  border-radius: 4px;\n  padding: 10px;\n  width: ", "px;\n  color: ", ";\n  background: ", ";\n  border: 1px solid ", ";\n  font-size: ", ";\n  line-height: 1;\n  text-transform: none;\n  box-shadow: 0 0 16px rgba(89, 146, 199, 0.25);\n  top: ", "px;\n  left: ", "px;\n  opacity: ", ";\n"], ["\n  ", "\n  position: fixed;\n  z-index: 1901;\n  border-radius: 4px;\n  padding: 10px;\n  width: ", "px;\n  color: ", ";\n  background: ", ";\n  border: 1px solid ", ";\n  font-size: ", ";\n  line-height: 1;\n  text-transform: none;\n  box-shadow: 0 0 16px rgba(89, 146, 199, 0.25);\n  top: ", "px;\n  left: ", "px;\n  opacity: ", ";\n"])), CommonStyle, function (_a) {
    var width = _a.width;
    return width;
}, getColor('grey', 120), getColor('blue', 10), getColor('blue', 40), getFontSize('default'), function (_a) {
    var top = _a.top;
    return top;
}, function (_a) {
    var left = _a.left;
...
var TooltipTitle = styled.div(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  color: ", ";\n  font-weight: 700;\n  margin-bottom: 5px;\n"], ["\n  color: ", ";\n  font-weight: 700;\n  margin-bottom: 5px;\n"])), getColor('blue', 120));
...
var Tooltip = function (_a) {
    ...
    var _e = useBooleanState(false), isVisible = _e[0], showTooltip = _e[1], hideTooltip = _e[2];
    ...
    var _f = useState([0, 0]), position = _f[0], setPosition = _f[1];
    useEffect(function () {
    ...
    return (React.createElement(TooltipContainer, __assign({ ref: parentRef, role: "tooltip" }, rest, { size: iconSize, onMouseEnter: showTooltip, onMouseLeave: hideTooltip }),
        React.createElement(TooltipIcon, { size: iconSize }),
        isVisible &&
            createPortal(React.createElement(TooltipContent, { ref: contentRef, direction: direction, width: width, top: top, left: left }, children), portalRef.current)));
};
