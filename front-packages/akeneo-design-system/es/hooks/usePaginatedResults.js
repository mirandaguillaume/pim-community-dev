...
var usePaginatedResults = function (fetcher, dependencies, shouldFetch) {
    ...
    var _a = useState(null), results = _a[0], setResults = _a[1];
    var _b = useState(0), page = _b[0], setPage = _b[1];
    var isFetchingRef = useRef(false);
    var _c = useState(0), fetchTrigger = _c[0], setFetchTrigger = _c[1];
    var _d = useBooleanState(), isLastPage = _d[0], onLastPage = _d[1], notOnLastPage = _d[2];
    ...
    useEffect(function () {
        ...
        setFetchTrigger(function (t) { return t + 1; });
    }, dependencies);
    useEffect(function () {
        if (isFetchingRef.current || isLastPage || !shouldFetch)
            return;
                    ...
                    case 1:
                        ...
                        setResults(function (currentResults) {
                            if (0 === page || null === currentResults)
                                return newResults;
                            return __spreadArray(__spreadArray([], currentResults, true), newResults, true);
                        });
                        isFetchingRef.current = false;
                        return [2];
                }
