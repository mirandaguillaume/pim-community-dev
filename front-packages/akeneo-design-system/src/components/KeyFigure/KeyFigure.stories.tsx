...
import {KeyFigure, KeyFigureGrid as KeyFigureGridComponent} from './KeyFigure';
    ...
    return (
      <KeyFigureGridComponent>
        ...
        <KeyFigure
          ...
          title="Key figure 2 with a very very very very very long label"
        >
          <KeyFigure.Figure>123</KeyFigure.Figure>
        </KeyFigure>
