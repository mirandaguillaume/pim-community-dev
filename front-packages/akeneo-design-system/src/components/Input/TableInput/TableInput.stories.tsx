  ...
  render: args => {
    ...
    return (
      <TableInput {...args}>
        ...
        <TableInput.Body>
          {['Sugar', 'Salt', 'Pepper', 'Eggs', 'Flour', 'Yeast'].map((row, index) => (
            <TableInput.Row key={row}>
              <TableInput.Cell>
                <TableInput.CellContent rowTitle={true}>{row}</TableInput.CellContent>
              </TableInput.Cell>
              <TableInput.Cell>
                <TableInput.Select
                  clearLabel="Remove"
              ...
              <TableInput.Cell>
                <TableInput.Text value={getValue(index, 'part')} onChange={value => setValue(index, 'part', value)} />
              </TableInput.Cell>
              <TableInput.Cell>
                <TableInput.Number
                  value={getValue(index, 'quantity')}
                  onChange={value => setValue(index, 'quantity', value)}
                />
              </TableInput.Cell>
              <TableInput.Cell>
                <TableInput.Boolean
                  yesLabel="Yes"
                  noLabel="No"
                  value={getValue(index, 'is_allergenic')}
                  onChange={value => setValue(index, 'is_allergenic', value)}
                />
              </TableInput.Cell>
              <TableInput.Cell>
              ...
              <TableInput.Cell>
                ...
                >
                  {match('French (France)') && (
                    <Dropdown.Item onClick={() => setValue(index, 'origin', 'french')}>
                      <Image src="https://picsum.photos/seed/akeneo/200/140" alt="The alt" />
                      <Dropdown.Surtitle label="France">French (France)</Dropdown.Surtitle>
                      <Badge>100%</Badge>
                      <IconButton icon={<LinkIcon />} ghost="borderless" level="tertiary" />
                    </Dropdown.Item>
                  )}
                  {match('German (Germany)') && (
                    <Dropdown.Item onClick={() => setValue(index, 'origin', 'german')}>
                      <Image src="https://picsum.photos/seed/akenep/200/140" alt="The alt" />
                      <Dropdown.Surtitle label="Germany">German (Germany)</Dropdown.Surtitle>
                      <Badge>100%</Badge>
                      <IconButton icon={<LinkIcon />} ghost="borderless" level="tertiary" />
                    </Dropdown.Item>
                  )}
                  {match('English (United States)') && (
                    <Dropdown.Item onClick={() => setValue(index, 'origin', 'english')}>
                      <Image src="https://picsum.photos/seed/akener/200/140" alt="The alt" />
                      <Dropdown.Surtitle label="English">English (United States)</Dropdown.Surtitle>
                      <Badge>100%</Badge>
                      <IconButton icon={<LinkIcon />} ghost="borderless" level="tertiary" />
                    </Dropdown.Item>
                  )}
      ...
      <TableInput {...args}>
        ...
        <TableInput.Body>
          {[...Array(linesCount).keys()].map((_, r) => {
            return (
              <TableInput.Row key={r}>
                <TableInput.Cell>
                  <TableInput.CellContent rowTitle={true} highlighted={r === 0} inError={r === 1}>
                    Value
                  </TableInput.CellContent>
                </TableInput.Cell>
                <TableInput.Cell>
                  <TableInput.CellContent highlighted={r === 1} inError={r === 2}>
                    Value
                  </TableInput.CellContent>
                </TableInput.Cell>
                <TableInput.Cell>
                ...
                <TableInput.Cell>
                  <TableInput.Text value={'Text value'} highlighted={r === 3} inError={r === 4} />
                </TableInput.Cell>
                <TableInput.Cell>
                  <TableInput.Number value={42} highlighted={r === 4} inError={r === 5} />
                </TableInput.Cell>
                <TableInput.Cell>
                  <TableInput.Boolean
                    value={true}
        ...
        <TableInput.Body>
          {[...Array(linesCount).keys()].map((_, r) => {
            return (
              <TableInput.Row key={r}>
                <TableInput.Cell>
                  <TableInput.CellContent rowTitle={true}>Value</TableInput.CellContent>
                </TableInput.Cell>
                <TableInput.Cell>
                  <TableInput.Select onSearchChange={() => {}} value={'Cell with a select value having a big text'} />
                </TableInput.Cell>
                <TableInput.Cell>
                  <TableInput.Text value={'Cell with a text value having a big text'} />
                </TableInput.Cell>
                <TableInput.Cell>
                  <TableInput.Number value={Math.pow(4212345967, r)} />
                </TableInput.Cell>
                <TableInput.Cell>
                  <TableInput.Boolean value={true} yesLabel={'Yes'} noLabel={'No'} />
                </TableInput.Cell>
              </TableInput.Row>
            );
          })}
                ...
                {[...Array(columnCount).keys()].map((_, i) => {
                  return i === 0 ? (
                    <TableInput.Cell key={i}>
                      <TableInput.CellContent rowTitle={true}>Row {row + 1}</TableInput.CellContent>
                    </TableInput.Cell>
                  ) : (
                    <TableInput.Cell key={i}>
    ...
    return (
      <TableInput {...args}>
        ...
        <TableInput.Body>
          {[...Array(linesCount).keys()].map((_, r) => {
            return (
              <TableInput.Row key={r} highlighted={highlighted[r]}>
                <TableInput.Cell>
                  <TableInput.CellContent rowTitle={true}>Value</TableInput.CellContent>
                </TableInput.Cell>
