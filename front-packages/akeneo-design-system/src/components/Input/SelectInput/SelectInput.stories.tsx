...
export default {
  ...
  argTypes: {
    ...
    onChange: {
      ...
      table: {
        type: {
          summary: '(newValue: string | null) => void',
        },
      },
    },
  },
...
export const ReadOnly = {
  render: args => {
    ...
    return (
      <>
        <SelectInput {...args} readOnly={true} value={null} placeholder="Placeholder" emptyResultLabel="No match found">
          <SelectInput.Option value="en_US" title="English (United States)">
            <Locale code="en_US" languageLabel="English" />
          </SelectInput.Option>
          <SelectInput.Option value="fr_FR" title="French (France)">
    ...
    return (
      <>
        <SelectInput {...args} value={value} onChange={setValue} emptyResultLabel="No match found">
          ...
          <SelectInput.Option
            value="fr_FR"
            title="Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur."
          >
    ...
    return (
      <SpaceContainer height={170}>
        <SelectInput {...args} value={value} onChange={setValue} onNextPage={onNextPage}>
          {items.map(item => (
            <SelectInput.Option value={item} title={item} key={item}>
              Option {item + 1}
            </SelectInput.Option>
          ))}
        </SelectInput>
