...
const unitConfig = {
  ...
  coveragePathIgnorePatterns: [
    ...
    'src/Akeneo/Platform/Bundle/CommunicationChannelBundle',
  ...
  testPathIgnorePatterns: [
    ...
    '<rootDir>/src/Akeneo/Platform/Bundle/UIBundle/Resources/workspaces/activity/',
    '<rootDir>/src/Akeneo/Pim/Structure/Bundle/Resources/workspaces/settings-ui/',
  ],
