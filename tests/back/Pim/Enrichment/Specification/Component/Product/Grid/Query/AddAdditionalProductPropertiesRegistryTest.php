...
class AddAdditionalProductPropertiesRegistryTest extends TestCase
{
    private AddAdditionalProductPropertiesRegistry $sut;

    protected function setUp(): void
    {
        $this->sut = new AddAdditionalProductPropertiesRegistry();
    }
