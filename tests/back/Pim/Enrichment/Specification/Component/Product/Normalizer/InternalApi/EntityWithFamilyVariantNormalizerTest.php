...
class EntityWithFamilyVariantNormalizerTest extends TestCase
{
    private EntityWithFamilyVariantNormalizer $sut;

    protected function setUp(): void
    {
        $this->sut = new EntityWithFamilyVariantNormalizer();
    }
