...
use Akeneo\Pim\Enrichment\Component\Product\Connector\Processor\MassEdit\AddAttributeValueProcessor;
...
class AddAttributeValueProcessorTest extends TestCase
{
    private AddAttributeValueProcessor $sut;

    protected function setUp(): void
    {
        $this->sut = new AddAttributeValueProcessor();
    }
