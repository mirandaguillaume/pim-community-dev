...
class DocumentationCollectionTest extends TestCase
{
    private DocumentationCollection $sut;

    protected function setUp(): void
    {
    }

    public function test_it_normalizes_the_information(): void
    {
        $this->sut = new DocumentationCollection([
                    new Documentation(
    ...
    public function test_it_validates_documentations(): void
    {
