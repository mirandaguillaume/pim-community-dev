 ...
 */
class ComputeDataRelatedToFamilySubProductModelsTaskletTest extends TestCase
{
    private ComputeDataRelatedToFamilySubProductModelsTasklet $sut;

    protected function setUp(): void
    {
        $this->sut = new ComputeDataRelatedToFamilySubProductModelsTasklet();
    }
