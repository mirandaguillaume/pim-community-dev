...
class FilteredProductAndProductModelReaderTest extends TestCase
{
    private FilteredProductAndProductModelReader $sut;

    protected function setUp(): void
    {
        $this->sut = new FilteredProductAndProductModelReader();
    }
