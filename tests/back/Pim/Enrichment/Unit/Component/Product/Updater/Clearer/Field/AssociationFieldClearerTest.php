...
use Akeneo\Pim\Enrichment\Component\Product\Updater\Clearer\Field\AssociationFieldClearer;
 ...
 */
class AssociationFieldClearerTest extends TestCase
{
    private AssociationFieldClearer $sut;

    protected function setUp(): void
    {
        $this->sut = new AssociationFieldClearer();
    }
