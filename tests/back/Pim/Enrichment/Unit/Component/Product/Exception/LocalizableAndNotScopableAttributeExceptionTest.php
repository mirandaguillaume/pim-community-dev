...
class LocalizableAndNotScopableAttributeExceptionTest extends TestCase
{
    private LocalizableAndNotScopableAttributeException $sut;

    protected function setUp(): void
    {
        $this->sut = LocalizableAndNotScopableAttributeException::fromAttributeChannelAndLocale('description', 'ecommerce', 'en_US');
    }

    public function test_it_is_a_domain_and_templated_error_exception(): void
    {
        $this->assertInstanceOf(LocalizableAndNotScopableAttributeException::class, $this->sut);
    ...
    {
        $this->sut = LocalizableAndNotScopableAttributeException::fromAttributeChannelAndLocale('description', null, null);
        $this->assertSame('The description attribute does not require a value per channel' .
                    ' (nothing was detected) but requires a value per locale (nothing was detected).', $this->sut->getMessage());
    }
}
