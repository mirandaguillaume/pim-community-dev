...
class ReferenceDataCollectionNormalizerTest extends TestCase
{
    private ReferenceDataCollectionNormalizer $sut;

    protected function setUp(): void
    {
        $this->sut = new ReferenceDataCollectionNormalizer();
    }
