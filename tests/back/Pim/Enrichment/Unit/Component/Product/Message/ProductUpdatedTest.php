 ...
 */
class ProductUpdatedTest extends TestCase
{
    private ProductUpdated $sut;

    protected function setUp(): void
    {
        $this->sut = new ProductUpdated(Author::fromNameAndType('julia', Author::TYPE_UI),
            [
    ...
    {
        $this->assertInstanceOf(ProductUpdated::class, $this->sut);
    }
    ...
    {
        $this->assertSame('product.updated', $this->sut->getName());
    }
