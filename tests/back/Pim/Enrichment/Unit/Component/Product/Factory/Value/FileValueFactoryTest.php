...
use Akeneo\Pim\Enrichment\Component\Product\Factory\Value\FileValueFactory;
...
class FileValueFactoryTest extends TestCase
{
    ...
    {
        $this->assertSame(AttributeTypes::FILE, $this->sut->supportedAttributeType());
    }
