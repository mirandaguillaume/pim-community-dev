...
class ListChildrenCategoriesWithCountIncludingSubCategoriesTest extends TestCase
{
    private ListChildrenCategoriesWithCountIncludingSubCategories $sut;

    protected function setUp(): void
    {
        $this->sut = new ListChildrenCategoriesWithCountIncludingSubCategories();
    }
